...
const CartDropdown: React.FC = () => {
  ...
  const { cartItems, updateQuantity, removeItem, subtotal, itemCount } =
    useCart();
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <div
        className={`absolute right-0 mt-2 w-80 md:w-96 bg-white shadow-xl rounded-md border z-50 max-h-[90vh] md:max-h-[32rem] overflow-auto transform ${
          isOpen
