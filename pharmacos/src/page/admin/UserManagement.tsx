...
const API_URL = "https://68352d95cd78db2058c07934.mockapi.io/accounts";
    ...
    return (
        <>
            <Card>
                        ...
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                <div className="space-y-2">
                                    <p><strong>Username:</strong> {users.find((u) => u.id === detailsUserId)?.username}</p>
                                    <p><strong>Email:</strong> {users.find((u) => u.id === detailsUserId)?.email}</p>
                                    <p><strong>Role:</strong> {users.find((u) => u.id === detailsUserId)?.role}</p>
                                    <p><strong>Status:</strong> {users.find((u) => u.id === detailsUserId)?.status}</p>
                                    <p><strong>Created At:</strong> {users.find((u) => u.id === detailsUserId)?.createdAt}</p>
                                    <p><strong>Updated At:</strong> {users.find((u) => u.id === detailsUserId)?.updatedAt}</p>
                                </div>
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                            <AlertDialogCancel onClick={() => setDetailsUserId(null)}>Close</AlertDialogCancel>
                        </AlertDialogFooter>
                    </AlertDialogContent>
                </AlertDialog>
                ...
                >
                    <AlertDialogContent>
                        ...
                        <AlertDialogFooter>
                            ...
                            <AlertDialogAction onClick={saveEditDialog}>Save</AlertDialogAction>
                        </AlertDialogFooter>
                    </AlertDialogContent>
                </AlertDialog>
                        ...
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                ...
                                <div className="mt-4 space-y-2">
                                    <p><strong>Username:</strong> {confirmEditData?.username}</p>
                                    <p><strong>Email:</strong> {confirmEditData?.email}</p>
                                </div>
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                            <AlertDialogCancel onClick={() => setConfirmEditData(null)}>Cancel</AlertDialogCancel>
                            <AlertDialogAction onClick={confirmEditSave}>Confirm</AlertDialogAction>
                        </AlertDialogFooter>
                    </AlertDialogContent>
                </AlertDialog>
                ...
                {/* Add user dialog */}
                {/* Add user dialog */}
                <AlertDialog open={showAddDialog} onOpenChange={(open) => setShowAddDialog(open)}>
                    <AlertDialogContent>
                        <AlertDialogHeader>
                        ...
                        <AlertDialogFooter>
                            ...
                            <AlertDialogAction onClick={handleAddUser}>Create</AlertDialogAction>
                        </AlertDialogFooter>
                    </AlertDialogContent>
                </AlertDialog>
